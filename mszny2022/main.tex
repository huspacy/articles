...
\author{György Orosz\inst{1,2} \and
    Zsolt Szántó\inst{1,2} \and \break
    Péter Berkecz\inst{1,2} \and
    Gergő Szabó\inst{1,2} \and
    Farkas Richárd\inst{1,2}\\
    \institute{
        $^1$Artificial Intelligence National Laboratory \break
        $^2$Institute of Informatics, University of Szeged\break
        Szeged Árpád tér 2., H-6720
    }
    \email{gyorgy@orosz.link}\break
    \email{\{szantozs,rfarkas\}@inf.u-szeged.hu}\break
    \email{\{berkecz.peter,szabogergo.a\}@gmail.com}\break
}
